...
function App() {
  ...
  //currency info me pura data agya. both keys and values

  const options=Object.keys(currencyInfo) //objects se sari keys nikali.. wahi to deni hein user ko bas
  ...
  return (
    ...
    >
        <div className="w-full">
            <div className="w-full max-w-md mx-auto border border-black-100 rounded-lg p-5 backdrop-blur-sm bg-white/20">
                <form
                    onSubmit={(e) => {
                        e.preventDefault();
                        convert()
